DefinitionBlock ("", "SSDT", 2, "HACK", "PCI", 0x00000000)
{
	...
	Device (_SB.PCI0.RP08)
	{
		...
		Method (_DSM, 4, NotSerialized)
		{
			...
			Return (Package ()
			{
				"model", Buffer () { "C610/X99 series chipset PCI Express Root Port #8" },
				"device_type", Buffer () { "PCI bridge" },
	...
	External (_SB_.PCI1.IIOP, DeviceObj)
	Device (_SB.PCI1.IIOP)
	{
		Name (_ADR, 0x00000000)
		Method (_DSM, 4, NotSerialized)
		{
			...
			Return (Package ()
			{
				"model", Buffer () { "Xeon E7 v4/Xeon E5 v4/Xeon E3 v4/Xeon D PCI Express Root Port 0" },
				"device_type", Buffer () { "PCI bridge" },
				"AAPL,slot-name", Buffer () { "Internal@128,0,0" },
			})
		}
	}
	External (_SB_.PCI1.QR1A, DeviceObj)
	Device (_SB.PCI1.QR1A)
	{
		Name (_ADR, 0x00010000)
		Method (_DSM, 4, NotSerialized)
		{
			...
			Return (Package ()
			{
				"model", Buffer () { "Xeon E7 v4/Xeon E5 v4/Xeon E3 v4/Xeon D PCI Express Root Port 1" },
				"device_type", Buffer () { "PCI bridge" },
				"AAPL,slot-name", Buffer () { "Internal@128,1,0" },
			})
		}
	}
	External (_SB_.PCI1.QR1B, DeviceObj)
	Device (_SB.PCI1.QR1B)
	{
		Name (_ADR, 0x00010001)
		Method (_DSM, 4, NotSerialized)
		{
			...
			Return (Package ()
			{
				"model", Buffer () { "Xeon E7 v4/Xeon E5 v4/Xeon E3 v4/Xeon D PCI Express Root Port 1" },
				"device_type", Buffer () { "PCI bridge" },
				"AAPL,slot-name", Buffer () { "Internal@128,1,1" },
			})
		}
	}
	External (_SB_.PCI1.QR2A, DeviceObj)
	Device (_SB.PCI1.QR2A)
	{
		Name (_ADR, 0x00020000)
		Method (_DSM, 4, NotSerialized)
		{
			...
			Return (Package ()
			{
				"model", Buffer () { "Xeon E7 v4/Xeon E5 v4/Xeon E3 v4/Xeon D PCI Express Root Port 2" },
				"device_type", Buffer () { "PCI bridge" },
				"AAPL,slot-name", Buffer () { "Internal@128,2,0" },
			})
		}
	}
	External (_SB_.PCI1.QR3A, DeviceObj)
	Device (_SB.PCI1.QR3A)
	{
		Name (_ADR, 0x00030000)
		Method (_DSM, 4, NotSerialized)
		{
			...
			Return (Package ()
			{
				"model", Buffer () { "Xeon E7 v4/Xeon E5 v4/Xeon E3 v4/Xeon D PCI Express Root Port 3" },
				"device_type", Buffer () { "PCI bridge" },
				"AAPL,slot-name", Buffer () { "Internal@128,3,0" },
			})
		}
	}
	...
	External (_SB_.PCI0.RP08.RTLA, DeviceObj)
	Device (_SB.PCI0.RP08.RTLA)
	{
		Name (_ADR, 0x00000000)
		Method (_DSM, 4, NotSerialized)
		{
	...
	External (_SB_.PCI0.BR2A.GFX0, DeviceObj)
	Device (_SB.PCI0.BR2A.GFX0)
	{
		Name (_ADR, 0x00000000)
		Method (_DSM, 4, NotSerialized)
		{
	...
	External (_SB_.PCI0.BR2A.HDAU, DeviceObj)
	Device (_SB.PCI0.BR2A.HDAU)
	{
	...
	Device (_SB.PCI0.BR1A.H000)
	{
		...
		Method (_DSM, 4, NotSerialized)
		{
			...
			Return (Package ()
			{
				"model", Buffer () { "LEGEND 850 NVMe SSD (DRAM-less)" },
				"device_type", Buffer () { "Non-Volatile memory controller" },
